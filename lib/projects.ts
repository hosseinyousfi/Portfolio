...
export const projects: Project[] = [
  ...
  },
  {
    ...
    card: {
      ...
      tagline:
        "پرداخت آنلاین شهریه و اقساط‌بندی خودکار، ماژول آموزشی کامل با آزمون آنلاین هوشمند و مدیریت هوشمند دانش‌آموزان و کارکنان؛ کاملاً شخصی‌سازی‌شده برای نیازهای مدرسه.",
      image: "/images/project-school.webp",
      tags: ["Django", "DRF", "MySQL", "Zarinpal"],
    },
    badges: ["Enterprise", "Financial Automation", "در حال استفاده در ۴ مدرسه"],
    description:
      "سامانه مدیریت یکپارچه موسسه آموزشی ادبستان جم؛ پلتفرمی سازمانی و ماژولار که کاملاً بر اساس نیازهای آموزشی، تربیتی و پرورشی مدرسه شخصی‌سازی شده است. قلب سیستم یک موتور مالی تمام‌خودکار است — از پرداخت آنلاین شهریه و اقساط‌بندی هوشمند با درگاه زرین‌پال تا حقوق پویای کارکنان — در کنار ماژول آموزشی کامل با آزمون آنلاین هوشمند و کلاس آنلاین، و مدیریت هوشمند دانش‌آموزان و کادر. این سامانه هم‌اکنون در ۴ مدرسه در حال استفاده است.",
    sections: [
      {
    ...
    info: [
      ...
      { label: "وضعیت", value: "در حال استفاده در ۴ مدرسه" },
    ],
    techs: [
      "Python / Django",
      "Django REST Framework",
