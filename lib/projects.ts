...
export const projects: Project[] = [
  ...
  },
  {
    ...
    card: {
      ...
      tagline:
        "پلتفرم سازمانی که مالیِ مدرسه را تمام‌خودکار می‌کند: پرداخت آنلاین شهریه، اقساط‌بندی هوشمند، رتبه اعتباری دانش‌آموز و حقوق پویای کارکنان.",
      image: "/images/project-school.webp",
      tags: ["Django", "DRF", "MySQL", "Zarinpal"],
    },
    badges: ["Enterprise", "Financial Automation", "دارای کاربران فعال"],
    description:
      "ادبستان جم بزرگ‌ترین پروژه‌ای است که تا امروز ساخته‌ام: سامانه مدیریت یکپارچه یک موسسه آموزشی واقعی با کاربران فعال. قلب سیستم، یک موتور مالی تمام‌خودکار است — از پرداخت آنلاین شهریه و اقساط‌بندی هوشمند با درگاه زرین‌پال تا رتبه اعتباری زنده برای هر دانش‌آموز و محاسبه پویای حقوق کارکنان. در کنار آن، مدیریت کامل دانش‌آموزان و کادر، و یک ماژول آموزشی کامل شامل تکلیف، نمره‌دهی و آزمون آنلاین ضدتقلب.",
    sections: [
      {
      ...
      },
      {
        ...
        body: "ادبستان جم کل چرخه مالی و اداری موسسه را در یک سامانه ماژولار خودکار می‌کند؛ هر نقش (موسس، مدیر مدرسه، مدیر مالی، معلم، دانش‌آموز/اولیا) داشبورد اختصاصی خودش را دارد و داده‌ها یک‌بار ثبت و همه‌جا هم‌گام می‌شوند.",
      },
      {
