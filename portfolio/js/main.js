...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var modalFull = document.getElementById("project-modal-full");
  var modalStack = document.getElementById("project-modal-stack");
  ...
  function openModal(card) {
    ...
    modalFull.textContent = card.getAttribute("data-full");
    ...
    stack.forEach(function (tech) {
      ...
      span.className = "ltr rounded-lg border border-brand/20 bg-brand/10 px-3 py-1 text-xs font-semibold text-brand-bright";
